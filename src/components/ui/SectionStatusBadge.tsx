 ...
 * Status types: 'pending' | 'ready' | 'generating' | 'in_review' | 'finalized'
 *
 * Status Flow:
 * - pending: No chapters assigned yet
 * - ready: Chapters assigned, not generated
 * - generating: Questions being generated by AI
...
export function SectionStatusBadge({
  ...
  const statusConfig = {
    ...
    generating: {
      label: 'Generating',
      styles: 'bg-purple-100 text-purple-700 border border-purple-300',
      icon: (
